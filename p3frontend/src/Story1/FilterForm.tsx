                ...
                <FormGroup>
                    ...
                    <Input type="select">
                        {this.state.programTypeSelection.map((selection:string,i:number) => {
                            return(<option value={selection} key={i} onChange={this.setProgramType}>{selection}</option>)
                        })}
                    </Input>
                </FormGroup>
                <FormGroup>
                    ...
                    <Input type="select">
                        {this.state.clientSelection.map((selection:string,i:number) => {
                            return(<option value={selection} key={i} onClick={this.setClient}>{selection}</option>)
                        })}
                    </Input>
                </FormGroup>
                <FormGroup>
                    ...
                    <Input type="select">
                        {this.state.curriculumSelection.map((selection:string,i:number) => {
                            return(<option value={selection} key={i} onClick={this.setCurriculum}>{selection}</option>)
                        })}
                    </Input>
                </FormGroup>
