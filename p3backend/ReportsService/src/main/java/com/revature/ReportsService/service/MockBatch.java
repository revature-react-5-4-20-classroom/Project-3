...
public class MockBatch {
  ...
  public MockBatch() {
    ...
    this.batches.add(new Batch(1, 3, LocalDate.parse("2020-08-01"), LocalDate.parse("2020-11-01"),
        false, 70, 1));
    this.batches.add(
        new Batch(2, 2, LocalDate.parse("2020-08-01"), LocalDate.parse("2020-11-01"), true, 80, 2));
    this.batches.add(new Batch(3, 1, LocalDate.parse("2020-08-01"), LocalDate.parse("2020-11-01"),
        false, 90, 3));
    this.nextId = 4;
  }
